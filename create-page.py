...
root_resource_id = get_root_resource_id(api_id)
print("root_resource_id = " + root_resource_id)
...
print("Assigned GET to resource")
assign_get_method_response(api_id, resource_id)
print("Assigned response for GET to resource")
